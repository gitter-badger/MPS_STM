...
public class ConvertIfToMyIf_Intention extends BaseIntention implements Intention {
  ...
  public void execute(final SNode node, final EditorContext editorContext) {
    SNode statement = SConceptOperations.createNewNode("SampleExtensions.structure.MyIfStatement", null);
    SLinkOperations.setTarget(statement, "condition", SLinkOperations.getTarget(node, "condition", true), true);
    SNode ifBody = SConceptOperations.createNewNode("SampleExtensions.structure.TrueFlow", null);
    ...
    SLinkOperations.setTarget(statement, "alternative", SConceptOperations.createNewNode("SampleExtensions.structure.FalseFlow", null), true);
