...
public class MoneyConversionType extends Type {
  public static final String concept = "Money.structure.MoneyConversionType";
  ...
  public static MoneyConversionType newInstance(SModel sm, boolean init) {
    return (MoneyConversionType) SModelUtil_new.instantiateConceptDeclaration("Money.structure.MoneyConversionType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
