...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  private static String[] stringSwitchCases_1htk8d_a0a0a = new String[]{"Money.structure.ConvertTo", "Money.structure.CurrencyDefTable", "Money.structure.CurrencyUnit", "Money.structure.GetAmount", "Money.structure.GetCurrency", "Money.structure.MoneyConversionType", "Money.structure.MoneyLiteral", "Money.structure.MoneyType"};
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0a, conceptFqName)) {
      ...
      case 1:
        return new CompiledConceptDescriptor("Money.structure.CurrencyDefTable", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept"}, new String[]{}, new String[]{});
      case 2:
        return new CompiledConceptDescriptor("Money.structure.CurrencyUnit", "jetbrains.mps.lang.core.structure.BaseConcept", false, new String[]{"jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept"}, new String[]{}, new String[]{});
      case 3:
      ...
      case 6:
        return new CompiledConceptDescriptor("Money.structure.MoneyLiteral", "jetbrains.mps.baseLanguage.structure.Expression", false, new String[]{"jetbrains.mps.baseLanguage.structure.Expression"}, new String[]{"amount"}, new String[]{"unit"});
      case 7:
