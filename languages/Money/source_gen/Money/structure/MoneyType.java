...
public class MoneyType extends Type {
  public static final String concept = "Money.structure.MoneyType";
  ...
  public static MoneyType newInstance(SModel sm, boolean init) {
    return (MoneyType) SModelUtil_new.instantiateConceptDeclaration("Money.structure.MoneyType", sm, GlobalScope.getInstance(), init).getAdapter();
  }
