...
public class GetCurrency_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer canBeChildBreakingPoint = new SNodePointer("r:287f3730-82f2-4e81-b8c8-89838004f6d4(Money.constraints)", "1790427706118304184");

  public GetCurrency_Constraints() {
    super("Money.structure.GetCurrency");
  }
